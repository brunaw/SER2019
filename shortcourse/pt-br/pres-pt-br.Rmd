...
- Para todos os pacotes, existe um fluxo a ser seguido.

- O fluxo involve, basicamente, obter os IDs dos obejtos dos quais
queremos as informações (como artistas, albúns, músicas) e passar
estes IDs para funcões específicas;
...
*nao fala de maria* e *não fala de maria*,
